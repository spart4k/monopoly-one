...
export const BOARD_CONFIG: ISpaceData[] = [
  ...
  { id: 1, name: 'ул. Ленинградская', type: 'property', color: 'bg-amber-800', textColor: 'text-white', price: 60, baseRent: 2, rentWithHouse: [10,30,90,160], rentWithHotel: 250, houseCost: 50, mortgageValue: 30 },
  ...
  { id: 3, name: 'ул. Вилоновская', type: 'property', color: 'bg-amber-800', textColor: 'text-white', price: 60, baseRent: 4, rentWithHouse: [20,60,180,320], rentWithHotel: 450, houseCost: 50, mortgageValue: 30 },
  ...
  { id: 9, name: 'ул. Молодогвардейская', type: 'property', color: 'bg-sky-400', textColor: 'text-gray-900', price: 120, baseRent: 8, rentWithHouse: [40,100,300,450], rentWithHotel: 600, houseCost: 50, mortgageValue: 60 },
  ...
  { id: 11, name: 'ул. Галактионовская', type: 'property', color: 'bg-pink-400', textColor: 'text-gray-900', price: 140, baseRent: 10, rentWithHouse: [50,150,450,625], rentWithHotel: 750, houseCost: 100, mortgageValue: 70 },
  { id: 12, name: 'Водоканал', type: 'property', color: 'bg-gray-300', textColor: 'text-gray-900', price: 150, baseRent: 4, rentWithHouse: [0,0,0,0], rentWithHotel: 0, houseCost: 0, mortgageValue: 75, description: 'Аренда = 4 × кубики (1 комуналка) или 10 × кубики (2)' },
  { id: 13, name: 'ул. Купеческая', type: 'property', color: 'bg-pink-400', textColor: 'text-gray-900', price: 140, baseRent: 10, rentWithHouse: [50,150,450,625], rentWithHotel: 750, houseCost: 100, mortgageValue: 70 },
  { id: 14, name: 'ул. Некрасовская', type: 'property', color: 'bg-pink-400', textColor: 'text-gray-900', price: 160, baseRent: 12, rentWithHouse: [60,180,500,700], rentWithHotel: 900, houseCost: 100, mortgageValue: 80 },
  ...
  { id: 18, name: 'ул. Братьев Коростылевых', type: 'property', color: 'bg-orange-400', textColor: 'text-gray-900', price: 180, baseRent: 14, rentWithHouse: [70,200,550,750], rentWithHotel: 950, houseCost: 100, mortgageValue: 90 },
  { id: 19, name: 'ул. Красноармейская', type: 'property', color: 'bg-orange-400', textColor: 'text-gray-900', price: 200, baseRent: 16, rentWithHouse: [80,220,600,800], rentWithHotel: 1000, houseCost: 100, mortgageValue: 100 },
  ...
  { id: 24, name: 'ул. Аэродромная', type: 'property', color: 'bg-red-500', textColor: 'text-white', price: 240, baseRent: 20, rentWithHouse: [100,300,750,925], rentWithHotel: 1100, houseCost: 150, mortgageValue: 120 },
  ...
  { id: 28, name: 'Электросети', type: 'property', color: 'bg-gray-300', textColor: 'text-gray-900', price: 150, baseRent: 4, rentWithHouse: [0,0,0,0], rentWithHotel: 0, houseCost: 0, mortgageValue: 75, description: 'Аренда = 4 × кубики (1 комуналка) или 10 × кубики (2)' },
  { id: 29, name: 'ул. Арцыбушевская', type: 'property', color: 'bg-yellow-400', textColor: 'text-gray-900', price: 280, baseRent: 24, rentWithHouse: [120,360,850,1025], rentWithHotel: 1200, houseCost: 150, mortgageValue: 140 },
